...
/**
 * This is the item provider adapter for a {@link questionairemodel.IntegerQuestion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerQuestionItemProvider
	 ...
	 * @generated
	 */
	public IntegerQuestionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerQuestion_minValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerQuestion_minValue_feature", "_UI_IntegerQuestion_type"),
				 QuestionairemodelPackage.Literals.INTEGER_QUESTION__MIN_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerQuestion_step_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerQuestion_step_feature", "_UI_IntegerQuestion_type"),
	...
	protected void addMaxValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerQuestion_maxValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerQuestion_maxValue_feature", "_UI_IntegerQuestion_type"),
	...
	/**
	 * This returns IntegerQuestion.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IntegerQuestion"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IntegerQuestion.class)) {
