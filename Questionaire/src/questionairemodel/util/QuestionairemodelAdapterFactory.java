...
public class QuestionairemodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected QuestionairemodelSwitch<Adapter> modelSwitch =
		new QuestionairemodelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseQuestionBase(QuestionBase object) {
				return createQuestionBaseAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link questionairemodel.QuestionBase <em>Question Base</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
